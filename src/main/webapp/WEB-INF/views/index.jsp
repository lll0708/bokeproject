...
>>>>>>> 755c82793d1a3b9fa210d7d0a7da609f3cc27a98
											</div>
										</div><!--username-dt end-->
										<div class="user-specs">
											<h3>${user.nickName}</h3>
...
>>>>>>> 356fe39db3bf9e477a13300953609510dc1ce418
=======
		</div>
	</main>
>>>>>>> 755c82793d1a3b9fa210d7d0a7da609f3cc27a98
...
<<<<<<< HEAD
                    <div class="chat-list" id="messageBox">
...
<script type="text/javascript">
    ...
    // 未阅读消息数
    $.getJSON("/countMessage.do", function (data) {
        if (data != null) {
    ...
    $(".chat-mg").on("click", function () {
        $.getJSON("/searchMessage.do", function (data) {
            console.log(data)
            ...
            if (data != null) {
               for (var i=0;i<data.length;i++){
                   value+="<div class=\"conv-list\" data_id="+data[i].rId+" >\n" +
                       "   <div class=\"usrr-pic\">\n" +
                       " <img src='"+data[i].user.headPortraint+"'>" +
                       "   <span class=\"active-status activee\"></span>\n" +
                       "  </div>\n" +
                       "  <div class=\"usy-info\">\n" +
                       "   <h3>"+data[i].user.nickName+"</h3>\n" +
                       "   <span>Lorem ipsum dolor <img src=\"images/smley.png\" alt=\"\"></span>\n" +
                       "     </div>\n" +
                       "   <div class=\"ct-time\">\n" +
    ...
    // 打开聊天框
    $(".conv-list").click(function () {
        var rid=$(this).attr("data_id");
        $.getJSON("/searchChat,do?rid="+rid,function () {
    ...
    $(".conv-list").on("click", function () {
        $(".chat-mg").next(".conversation-box").toggleClass("active");
        $(this).next(".conversation-box").removeclass("active");
        return false;
    });
</script>
